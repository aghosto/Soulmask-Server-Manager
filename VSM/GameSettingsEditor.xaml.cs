...
namespace SoulMaskServerManager
{
    public partial class GameSettingsEditor : Window
    {
        ...
        private void LoadPreset(string Preset)
        {
            ...
            //Stream stream = assembly.GetManifestResourceStream("SoulMaskServerManager.Resources." + Preset);
            Stream stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("SoulMaskServerManager.Resources." + Preset);
