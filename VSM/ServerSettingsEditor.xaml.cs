...
namespace SoulMaskServerManager
{
    ...
    public partial class ServerSettingsEditor : Window
    {
        ...
        {
            string fileToLoad = servers[serverIndex].Path + @"\Config\WindowsServer\Engine.ini";
            ...
            string iniFilePath = servers[serverIndex].Path + @"\Config\WindowsServer\Engine.ini";

            //ServerSettings LoadServerSetting = 
